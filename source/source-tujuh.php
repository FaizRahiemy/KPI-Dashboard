...
<body>
    <div id="container">
        ...
        <div id="header-detail">
            ...
            <span style="margin-left:-100px">LEVEL 2 SCOR SOURCE<br>sS3.7 AUTHORIZE SUPPLIER PAYMENT</span>
        </div>
        ...
        <?php
            ...
            $jumlahOnTimePayment = 0;
            $jumlahNotOnTimePayment = 0;
            for ($i = 0; $i < count($purchaseOrder); $i++){
                $jumlahOnTimePayment += $purchaseOrder[$i]['SuppliePaymentOnTime'];
                $jumlahNotOnTimePayment += $purchaseOrder[$i]['SupplierPaymentNotOnTime'];
            }
            $averageOnTimePayment = $jumlahOnTimePayment / count($purchaseOrder);
            $averageNotOnTimePayment = $jumlahNotOnTimePayment / count($purchaseOrder);
        ?>
        ...
        <div id="attribute">
                ...
                <div id="attribute-title" style="margin-left:2px">
                    <table style="border:0px;border-collapse: collapse; width: 100%; height: 50px">
                        <tr>
                            ...
                            <td style="background: #d9d9d9; padding: 5px;"><b>KPI: </b> Authorize Supplier Payment Cycle Time Accuracy</td>
                        </tr>
                    </table>
                </div>
                ...
                <div id="attribute-left-top">
                    ...
                    <span style="float:left; text-align:center; margin-left:15px;margin-top:90px;width:40%">
                        <table style="text-align:center; font-size:18px;">
                            <tr>
                                <td colspan="2" style="color:white">Last Quarter Payment Cycle Time</td>
                            </tr>
                            <tr style="font-weight:bold">
                                <td style="color:#A5B592">Payment On Time<br> <?php echo number_format($lastPurchaseOrder['SuppliePaymentOnTime']/($lastPurchaseOrder['SuppliePaymentOnTime'] + $lastPurchaseOrder['SupplierPaymentNotOnTime']) *100, 1); ?>%</td>
                                <td style="color:#F3A447">Payment Not Ontime<br> <?php echo number_format($lastPurchaseOrder['SupplierPaymentNotOnTime']/($lastPurchaseOrder['SuppliePaymentOnTime'] + $lastPurchaseOrder['SupplierPaymentNotOnTime']) *100, 1); ?>%</td>
                            </tr>
                        </table>
                    </span>
                </div>
            ...
            <div id="attribute-right">
                ...
                <div id="attribute-right-bottom" style="margin-right:2px">
                    <table style="">
                        <tr>
                            <td style="padding: 5px; border-right: solid 2px white;">Total on time for last 16 quarter<br> <?php echo $jumlahOnTimePayment ?></td>
                            <td style="padding: 5px;">Total not on time for last 16 quarter<br> <?php echo $jumlahNotOnTimePayment ?></td>
                        </tr>
                    </table>
                </div>
...
<script type="text/javascript">
    ...
    function drawChart() {
        var dataResponsivenessLeftTop = google.visualization.arrayToDataTable([
            ['Task', 'Hours per Day'],
            ['On time',     <?php echo $lastPurchaseOrder['SuppliePaymentOnTime']; ?>],
            ['not on time',     <?php echo $lastPurchaseOrder['SupplierPaymentNotOnTime']; ?>]
        ]);
...
<script type="text/javascript">
    ...
    function drawStacked() {
        var dataResponsivenessLeftBottom = google.visualization.arrayToDataTable([
            ...
            ['', <?php echo $averageOnTimePayment ?>, <?php echo $averageNotOnTimePayment ?>]
        ]);
    ...
    function drawColColors() {
        ...
        data.addRows([
            ...
            for ($i = count($purchaseOrder)-1; $i >= 0; $i--){
                ...
                echo "['Q".$order['Quarter']."-".trim($order['Year'],'20')."', ".$order['SuppliePaymentOnTime'].", ".$order['SupplierPaymentNotOnTime']."],";
            }
            ?>
        ]);
...
<script type="text/javascript">
    ...
    function drawChart() {
        var dataResponsivenessLeftTop = google.visualization.arrayToDataTable([
            ['Task', 'Hours per Day'],
            ['Supplier Meeting Criteria',     11],
            ['Supplier Not Meeting Criteria',      2]
        ]);
