...
<body>
    <div id="container">
        ...
        <div id="header-detail">
            ...
            <span style="margin-left:-100px">LEVEL 2 SCOR SOURCE<br>sD3.1 OBTAIN AND RESPOND TO RFP/RFQ</span>
        </div>
        ...
        <?php
            ...
            for ($i = 0; $i < count($makeArray); $i++){
                $jumlahAktual += $makeArray[$i]['ObtainRFQOnTimeActual'];
                $jumlahTarget += $makeArray[$i]['ObtainRFQOnTimeTarget'];
            }
                ...
                <div id="attribute-title" style="margin-left:2px">
                    <table style="border:0px;border-collapse: collapse; width: 100%; height: 50px">
                        <tr>
                            ...
                            <td style="background: #d9d9d9; padding: 5px;"><b>KPI: </b> Obtain & Respond to request for quote (RFQ) / request for proposal (RFP) cycle time</td>
                        </tr>
                    </table>
                </div>
                ...
                <div id="attribute-left-top">
                    ...
                    <span style="float:left; text-align:center; margin-left:15px;margin-top:90px; width:40%;">
                        <table style="text-align:center; font-size:18px">
                            <tr>
                                <td colspan="2" style="color:white">Last Quarter RFQ/RFP Cycle Time</td>
                            </tr>
    ...
    function drawColColors() {
        ...
        data.addRows([
            ...
            for ($i = count($makeArray)-1; $i >= 0; $i--){
                $order = $makeArray[$i];
                echo "['Q".$order['Quarter']."-".trim($order['Year'],'20')."', ".$order['ObtainRFQOnTimeActual'].", ".$order['ObtainRFQOnTimeTarget']."],";
            }
            ?>
        ]);
